    ...
    <div class="space-y-4">
        <div class="flex">
            ...
            <div class="flex-1 bg-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
                <strong>asd</strong> <span class="text-xs text-gray-400"></span>
                <p class="text-xs sm:text-sm">asd</p>
                            ...
                            <div class="space-y-4">
                                <div class="flex">
                                    ...
                                    <div class="flex-1 bg-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed" style="margin-bottom: 50px">
                                        ...
                                        <p class="text-xs sm:text-sm"><textarea placeholder="оставьте комментарий"></textarea></p>
                                        <div class="text-right">
                                            <button type="button" class="border bg-gray-200 text-gray-700 rounded-md px-4 py-2 m-2">Light</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

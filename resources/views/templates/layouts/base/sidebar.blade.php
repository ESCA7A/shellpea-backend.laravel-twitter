...
{{--            </li>--}}
            <li>
                <a rel="noopener noreferrer" href="{{ route('chats.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
        ...
        <ul class="pt-4 pb-2 space-y-1 text-sm">
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a rel="noopener noreferrer" class="flex items-center p-2 space-x-3 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
